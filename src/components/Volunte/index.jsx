...
export const Volunte = ({ data, loading, error }) => {
  ...
  return (
    <div className="volunte bg-c200 py-12 mt-5 relative overflow-hidden">
      <div className="container">
        <img src={bg} className="absolute" />
        <div className="description w-full text-center md:text-left md:w-5/12 inline-block text-c000 mb-10 md:mb-auto md:ml-20">

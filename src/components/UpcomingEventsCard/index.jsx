...
class UpcomingEventsCard extends React.Component {
  ...
  render() {
    ...
    return (
      <div className=" Upcoming-Events-Card relative z-20 col-start-8 col-end-13 row-start-1 row-end-3">
        <div className="absolute z-30">
          <img src={bg2} alt="upcoming events right-bg" />
        </div>
        <div className="h-full z-40 right-fund-card text-c000 flex flex-col items-center justify-between pt-16">
          <div className="guage">

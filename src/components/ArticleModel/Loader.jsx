...
export const HeadlineLoader = () => (
         ...
         >
           ...
           <rect x="0" y="91" rx="2" ry="2" width="500" height="4" />
         </ContentLoader>
       );
       ...
       export const BodyText = () => (
                <ContentLoader
                  ...
                  foregroundColor="#ecebeb"
                >
                  <rect x="0" y="3" rx="2" ry="2" width="500" height="11" />
                  <rect x="0" y="20" rx="2" ry="2" width="500" height="11" />
                  <rect x="0" y="38" rx="2" ry="2" width="500" height="11" />
                  <rect x="0" y="57" rx="2" ry="2" width="500" height="11" />
